...
const REQUIRED_FNS = [
  ...
  "pickLaterClosedListAssignmentSide",
  "mergeSyncTombstoneMaps",
  "omitTombstonedIdRecords",
  "coerceIdRecordList",
  "simpleIdListPulseSignature",
  "mergeCloudSyncSimpleIdListPulseIntoState",
  "omitTombstonesFromStopDoingLists",
  ...
  "mergeBackwardMeasurePeriodEntryForSync",
  "mergeBackwardMeasureKindStoreForSync",
  "mergeBackwardMeasureForSync",
  "mergeBackwardMeasurePeriodKeysForSync",
  "mergeDailyWinTomorrowRefForSync",
  "filterDailyWinTomorrowRefByTombstones",
  "pickMergedDoneRefItemId",
